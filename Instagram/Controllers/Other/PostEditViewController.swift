...
//  Instagram
//
//  Created by Anıl Bürcü on 28.03.2023.
//
import CoreImage
import UIKit
...
class PostEditViewController: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now()+4) { // filtre işlemi çok zor bir task olduğu için gecikmeli olarak yüklüyoruz
